...
<div class="wrapper">
	...
	<?php include 'includes/navbar.php'; ?>
	  ...
	  <div class="content-wrapper"  style="background-image:url('https://c4.wallpaperflare.com/wallpaper/523/510/376/tricolour-indian-flag-hd-5k-wallpaper-preview.jpg'); background-repeat:no-repeat;background-size:1390px 600px;" >
	    <div class="container" >
...
$(function(){
	...
	$(document).on('click', '.platform', function(e){
		...
		var fullname = $(this).data('firstname');
